...
class _EventsAdminState extends State<EventsAdmin> {
  ...
  Future<void> _approveEvent(DocumentSnapshot event) async {
    ...
    final posterId =
        eventData['userId']; // Ensure this field exists in your event posts
  ...
  Future<void> _rejectEvent(DocumentSnapshot event) async {
    ...
    final posterName = postData['userName'] ??
        'Someone'; // Ensure this exists in your postData
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // Fix: Properly extract location data from the Map
